...
# Script Location: CisGraph/GC/DNAmetGC.py
# Utils: Vers2.0
...
proBed = readBed(home + "genomeAnnotations/Regions/TSS.hg19.Idx.bed")
...
conBed = readBed(home + "ARBSs/regions/cons-arbs.bed")
conBed = sortBed(conBed)


indBed = readBed(home + "ARBSs/regions/ind-arbs.bed")
indBed = sortBed(indBed)



nonBed = readBed(home + "ARBSs/regions/Non-Active-ARBS.bed")
nonBed = sortBed(nonBed)


GCmetBed = {}
with open(home + "GCcontent/GCint.bed") as tsvfile:
...
boxPlot(data=data, combs=combs, colorPalette="Greys", y1=y1, yDec=yDec, ylim=ylim, multiTest=True)
