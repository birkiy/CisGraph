...
plt.title("# of open CRE\nwithin ARBS classes", fontsize=15)
plt.ylabel("# of open CRE (log scaled)", fontsize=14)
...
plt.xlabel("NodeClasses", fontsize=14)
plt.title("# of open CRE within ARBS classes", fontsize=15)
plt.ylabel("# of open CRE", fontsize=14)
