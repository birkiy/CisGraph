...
HiChip.rep1 = makeGenomicInteractionsFromFile(InteractionFile,
	type="chiapet.tool", experiment_name="HiChip", description="ChiA-PET VCaP")
...
df_all = as.data.frame(HiChip[isInteractionType(HiChip, c("gen", "enP", "enh"),
                                              c("gen", "enP", "enh"))])
...
write.table(df5,file = "Data/GIs/HiChip/GI.G.txt",
