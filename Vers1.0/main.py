...
# subprocess.call ([envR + "/bin/Rscript", "--vanilla", "/home/birkiy/github/CisGraph/Vers1.0/GI2NX/GI.VCaP/GI.G.VCaP.R"])
#
# print("\nGI code is running for T VCaP!\n")
# subprocess.call ([envR + "/bin/Rscript", "--vanilla", "/home/birkiy/github/CisGraph/Vers1.0/GI2NX/GI.VCaP/GI.T.VCaP.R"])
#
# print("\nGI code is running for C VCaP!\n")
# subprocess.call ([envR + "/bin/Rscript", "--vanilla", "/home/birkiy/github/CisGraph/Vers1.0/GI2NX/GI.VCaP/GI.C.VCaP.R"])
