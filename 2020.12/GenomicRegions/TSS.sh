...
# Homer Annotation
annotatePeaks.pl tss hg19 -size -350,350 -cTSS > TSS.hg19.gtf
annotatePeaks.pl tts hg19 -size -350,350 -cTSS > TTS.hg19.gtf
...
cut -f1,2,3,4 TSS.hg19.Idx.bed > TSS.hg19.Idx.cut.bed
...
#
# nARBS=~/ARBSs/regions/negativeControl.ARBS.bed
...
#
# bedtools getfasta -fi $fi -bed $nARBS -fo fasta/negativeControl.AR.fasta
# bedtools getfasta -fi $fi -bed $con -fo fasta/con.hg19.fasta
# bedtools getfasta -fi $fi -bed $ind -fo fasta/ind.hg19.fasta
# bedtools getfasta -fi $fi -bed $non -fo fasta/non.hg19.fasta
