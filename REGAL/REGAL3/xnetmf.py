...
def get_features(graph, rep_method, verbose = True):
	...
	if verbose:
		...
		print("got k hop neighbors in time: ", str(after_khop - before_khop))
	...
	if verbose:
		print("got degree sequences in time: ", str(after_degseqs - before_degseqs))
...
def get_representations(graph, rep_method, verbose = True):
	...
	if verbose:
		print("computed representation in time: ",str(after_computerep - before_computerep))
